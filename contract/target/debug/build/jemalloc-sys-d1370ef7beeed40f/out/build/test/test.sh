...
for t in $@; do
  ...
  echo "=== ${t} ==="
  if [ -e "/home/manonymous/rust-counter/contract/target/debug/build/jemalloc-sys-d1370ef7beeed40f/out/jemalloc/${t}.sh" ] ; then
    ...
    enable_fill=1 \
    enable_prof=0 \
    . /home/manonymous/rust-counter/contract/target/debug/build/jemalloc-sys-d1370ef7beeed40f/out/jemalloc/${t}.sh && \
    export_malloc_conf && \
    $JEMALLOC_TEST_PREFIX ${t} /home/manonymous/rust-counter/contract/target/debug/build/jemalloc-sys-d1370ef7beeed40f/out/jemalloc/ /home/manonymous/rust-counter/contract/target/debug/build/jemalloc-sys-d1370ef7beeed40f/out/build/
  else
    export MALLOC_CONF= && \
    export_malloc_conf && \
    $JEMALLOC_TEST_PREFIX ${t} /home/manonymous/rust-counter/contract/target/debug/build/jemalloc-sys-d1370ef7beeed40f/out/jemalloc/ /home/manonymous/rust-counter/contract/target/debug/build/jemalloc-sys-d1370ef7beeed40f/out/build/
